import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,f as t}from"./app-270b75a5.js";const l={},a=t(`<h1 id="matplotlib-缺少-tkinter" tabindex="-1"><a class="header-anchor" href="#matplotlib-缺少-tkinter" aria-hidden="true">#</a> Matplotlib 缺少 tkinter</h1><p>装了新版 Python 后使用 matplotlib 出现了这样的问题：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>****.py: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
  plt.show()
